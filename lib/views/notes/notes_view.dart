...
import 'package:saranotes/views/notes/notes_list_view.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () {
                  Navigator.of(context).pushNamed(creteOrUpdateNoteRoute);
                },
                  ...
                  return NotesListView(
                    ...
                    onTap: (note) {
                      Navigator.of(context)
                          .pushNamed(creteOrUpdateNoteRoute, arguments: note);
                    },
                  );
                } else {
